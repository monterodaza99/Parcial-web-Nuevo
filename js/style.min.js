...
function view(id, Codigo_Materia, Nombre_Materia, Creditos,Primer_corte,Segundo_corte, Tercer_corte) {
    ...
    insertRows.insertCell(8).innerHTML = '<div id="action"><button class="btn btn-warning" onclick="edit(' + id + ')">Edit</button> <br> <br> <button class="btn btn-dark" onclick="wipe(' + id + ')">Delete</button></div>';
}
